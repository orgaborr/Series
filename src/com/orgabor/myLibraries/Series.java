package com.orgabor.myLibraries;
...
public class Series {
	...
	public static int fibonacci(int n) {
		...
		if(n>1) {
			for(int i=2; i<=fibonacciArray.length-2; i++) { 					//length-2 to balance the extension																	
				fibonacciArray[i] = fibonacciArray[i-1] + fibonacciArray[i-2]; 	//at initialization of the array
			}
		}
